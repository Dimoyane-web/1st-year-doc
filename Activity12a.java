...
public class Activity12a
{
	public static void main(String[] args)
	{
		...
		System.out.print("Did you pass the semeter test? <Y>es or <N>o: ");
		Semester = kd.next().charAt(0);
		System.out.print("Enter your semester percentage marks: ");
		Semester_Test = kd.nextDouble();
		
		System.out.print("Did you pass the pratical project? <Y>es ot <N>o: ");
		Project = kd.next().charAt(0);
		
		System.out.print("Enter your pratical project percentage marks: ");
